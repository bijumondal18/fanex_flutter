                ...
                child: Column(
                  children: [
                    ...
                    CustomFullButton(
                        ...
                        onPressed: () {
                          print(buildParams(usernameController.text,
                              passwordController.text));
                          BlocProvider.of<LoginBloc>(context).add(
                              FetchLoginData(buildParams(
              ...
              listener: (context, state) {
                if (state is LoginLoadedState) {
                  if (state.loginResponseModel.ack.toString() != '0') {
                    ...
                    print(state.loginResponseModel.msg.toString());
                    ...
                    AppHelper.showBasicFlash(
                        context, state.loginResponseModel.msg.toString());
                  }
